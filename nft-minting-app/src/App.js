...
function App() {
  ...
  const claimNFTs = () => {
    ...
    setFeedback(`Minting your A Night With Taylor NFT...`);
    setClaimingNft(true);
      ...
      >
        ...
        >
          Public-Sale
            ...
            >
              <StyledLink target={"_blank"} href={CONFIG.SCAN_LINK} rel="noreferrer">
            ...
            {Number(data.totalSupply) >= CONFIG.MAX_SUPPLY ? (
              <>
                ...
                <s.SpacerSmall />
                <StyledLink target={"_blank"} href={CONFIG.MARKETPLACE_LINK} rel="noreferrer">
                  {CONFIG.MARKETPLACE}
                </StyledLink>
              </>
            ) : (
          ...
          >
            We have set the gas limit to {CONFIG.GAS_LIMIT} + 3000 for every additional NFT, for the contract to
...
<p>Each NFT costs about $100 in ETH and there are max. 500 entries.</p>
...
<p>If at least 200 NFTs are sold, an additional $5,000 in ETH will be given to the winner for travel.</p>
<p>Winner cannot resale tickets.</p>
<p>Random winner will be chosen on July 15th 2024.</p>
<p>Prize is valued at $25,000 including ETH, as of May 12th 2024.</p>
<p>Any additional funds will be used for NOWPayments.</p>
<s.SpacerSmall/>
